      ...
      <div className="container py-16 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/30 text-sm leading-relaxed max-w-xs" style={{ fontFamily: "var(--font-body)" }}>
              Residential design grounded in construction experience. Custom homes, infill housing, and multi-family projects across Vancouver Island, the Okanagan, and British Columbia.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-start gap-3 text-white/30 text-sm" style={{ fontFamily: "var(--font-body)" }}>
                ...
                <span>Nanoose Bay, BC<br />Vancouver Island</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/15 text-xs tracking-wider" style={{ fontFamily: "var(--font-body)" }}>
            Based in Nanoose Bay &middot; Serving Nanaimo, Parksville, Qualicum Beach, Lantzville, Vancouver Island, Okanagan, and BC
          </p>
        </div>
      </div>
    </footer>
