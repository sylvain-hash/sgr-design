...
const services = [
  ...
  },
  {
    ...
    description:
      "Using Revit, Civil 3D, and Enscape, we create detailed 3D models and photorealistic renderings that help you understand the design before construction begins. This makes it easier to visualize the final result, refine decisions early, and move forward with greater certainty.",
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              { title: "Infill Housing", desc: "Duplexes, fourplexes, carriage houses, laneway homes, and small-scale residential development." },
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              { title: "Developers", desc: "For multi-family and infill projects where design, unit planning, code awareness, and cost-conscious construction all matter." },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              },
              {
                ...
                a: "SGR Design is based in Nanoose Bay and serves Vancouver Island, the Okanagan, and clients across British Columbia."
              },
              {
                q: "Do you work with builders and developers?",
                a: "Yes. SGR Design works with private homeowners, builders, developers, and architects on custom homes, infill housing, and multi-family residential projects."
              },
              {
