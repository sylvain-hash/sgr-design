...
const caseStudies: CaseStudy[] = [
  ...
  {
    title: "The District at Predator Ridge — 60-Unit Community",
    location: "Vernon, BC",
    type: "Multi-family residential",
    ...
    image: images.predatorRidgeAerial,
  },
  {
      ...
      <section className="pt-32 lg:pt-40 pb-16 bg-[#0D1B2A]">
        <div className="container">
          <ScrollReveal>
            ...
            >
              A selection of significant residential projects designed by SGR Design across British Columbia and internationally.
            </p>
          </ScrollReveal>
        </div>
      </section>
          ...
          <ScrollReveal>
            <div className="max-w-2xl mx-auto">
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-body)" }}
              >
                Whether you're planning a custom home, multi-family development, or renovation, SGR Design can help you understand the next step.
              </p>
              <Link
                href="/contact"
