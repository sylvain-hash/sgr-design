            ...
            <div className="lg:col-span-3">
              ...
              <ScrollReveal delay={0.25}>
                <p
                  ...
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  Based in Nanoose Bay and serving Vancouver Island, the Okanagan, and clients across British Columbia, I work in many diverse styles — Traditional, Contemporary, Farmhouse, Beach/Lake, and French Country — always with constant attention to detail, proportion, livability, and site response.
                </p>
              </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <div>
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  When Sylvain isn't designing homes, he's enjoying the natural beauty of Vancouver Island with his family and dog. A lifelong builder and craftsman, he brings the same attention to detail and thoughtful approach to everything he does — whether it's designing a luxury residence or planning his next adventure.
                </p>
                <p
                  className="text-white/45 text-base leading-[1.85]"
                  style={{ fontFamily: "var(--font-body)" }}
