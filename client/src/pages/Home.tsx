...
const featuredProjects = [
  {
    ...
    title: "Evanshire Residence",
    category: "Custom Home",
  },
  {
    image: images.mallardOceanview,
    title: "Oceanview Living",
    category: "Custom Home",
  },
  {
    image: images.oakLeafAerial,
    title: "Modern Living",
    category: "Custom Home",
  },
];
    ...
    <PageLayout>
      ...
      <section className="relative h-screen min-h-[700px] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src={images.heroOakLeaf}
            alt="Modern contemporary home at twilight with expansive glass and stone"
        ...
        <div className="relative h-full container flex flex-col justify-end pb-24 lg:pb-32">
          ...
          >
            ...
            >
              Custom homes and multi-family residential design across British Columbia and internationally — led by a former builder with over 30 years of hands-on construction and design experience.
            </p>
            <p
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <ScrollReveal>
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-body)" }}
              >
                SGR Design Ltd. is a residential design studio based in Nanoose Bay, BC, led by principal designer Sylvain Giroux. With a background spanning carpentry, project management, custom home building, and full residential design, Sylvain brings a practical builder's eye to every project.
              </p>
              <p
                className="text-white/40 text-base leading-relaxed mb-8"
                style={{ fontFamily: "var(--font-body)" }}
              >
                The result is design that is refined, buildable, and carefully resolved — from early concept through permit and construction drawings. Every plan is approached not only as a design exercise, but as something that has to be beautiful and buildable.
              </p>
              <Link
                href="/about"
            ...
            <ScrollReveal delay={0.2}>
              <div className="relative">
                <img
                  src={images.rupertCourtyard}
                  alt="Elegant courtyard with fountain and landscaping"
      ...
      <section className="py-24 lg:py-36 bg-[#0D1B2A]">
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Custom Homes", desc: "Site-specific design for custom homes, duplexes, fourplexes, carriage houses, laneway homes, and small-scale residential development." },
              ...
              { title: "3D Modelling & Visualization", desc: "3D modeling and rendering that help clients, builders, and consultants understand the design before construction begins." },
            ].map((service, i) => (
            ...
            {[
              {
                ...
                desc: "Sylvain's background in carpentry, framing, project management, and custom home building gives each project a practical foundation."
              },
              {
              ...
              },
              {
                ...
                desc: "From custom homes to townhomes and multi-family communities, SGR Design works across a wide range of residential project types."
              },
              {
                title: "Clear Visualization Before Construction",
                desc: "3D modeling and rendering help clients and project teams understand the design before major decisions are made."
              },
            ].map((item, i) => (
            ...
            <ScrollReveal>
              <div className="border border-white/10 p-8 lg:p-10 hover:border-white/20 transition-colors duration-500">
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  <span className="text-white/60 font-medium">Nikki & Michael Nygren</span><br />
                  <span className="text-white/30">Custom Home Project</span>
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.1}>
              <div className="border border-white/10 p-8 lg:p-10 hover:border-white/20 transition-colors duration-500">
                ...
                >
                  ...
                  <span className="text-white/30">District Group — Multi-Family Projects</span>
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <div className="border border-white/10 p-8 lg:p-10 hover:border-white/20 transition-colors duration-500">
                ...
                <p
                  ...
                  style={{ fontFamily: "var(--font-body)" }}
                >
                  <span className="text-white/60 font-medium">Troy & Holly Gibson</span><br />
                  <span className="text-white/30">Custom Home Project</span>
                </p>
              </div>
            </ScrollReveal>
