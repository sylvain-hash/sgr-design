...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/mlgzlwjr", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          surveyStatus: form.surveyStatus,
          consultantInvolved: form.consultantInvolved,
      ...
      <section className="pt-32 lg:pt-40 pb-16 bg-[#0D1B2A]">
        <div className="container">
          <ScrollReveal>
            ...
            >
              Tell us about your property, project type, and timeline. Whether you are planning a custom home, multi-family development, or significant residential renovation, SGR Design Ltd. can help you understand the next step.
            </p>
          </ScrollReveal>
        </div>
      </section>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#1a2a3d] border border-white/10 text-white/80 px-4 py-3.5 text-sm focus:outline-none focus:border-white/25 transition-colors [&>option]:bg-[#1a2a3d] [&>option]:text-white/90"
                        style={{ fontFamily: "var(--font-body)" }}
                  ...
                  <div>
                    <label
                      ...
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      Do you already have a builder or engineer involved?
                    </label>
                    <select
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{ fontFamily: "var(--font-body)" }}
                    >
                      British Columbia &middot; International
                    </p>
                  </div>
                </div>
              </ScrollReveal>
